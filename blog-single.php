            ...
            <div class="container">
                <div class="page-title">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <ul class="ps-0">
                                <li><a href="blogs.php" class="text-white">Blog</a></li>
                                <li><a href="#!" class="text-white">Single Blog</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="blog-single">
            <div class="container">
                ...
                <div class="row g-xl-5 mt-n2-9">
                    ...
                    $pro_details = $db->get_results("SELECT * FROM tbl_blog WHERE slug='".$_REQUEST['slug']."'");
                    }
                    
                      if(count($pro_details)>0)
                      {
                          foreach($pro_details as $pro_dtls)
                          {?>
                            <div class="col-lg-12">
                                <article class="card card-style3 border-0 h-100">
                                    <img src="upload/blog/<?php echo $pro_dtls->image1?>" class="card-img-top" alt="...">
                                    <div class="card-body p-1-9 position-relative">
                                        <ul class="mb-2 p-0 d-inline-block">
                                            <li class="display-30 d-inline-block"><i class="fa fa-calendar pe-2 text-primary"></i><?php echo $pro_dtls->date; ?></li>
                                            <br>
                                            <li class="display-30 d-inline-block text-capitalize me-3"><a href="#!"><i class="fa fa-building text-primary pe-2"></i><?php echo $pro_dtls->company_name; ?></i></a></li>
                                        </ul>
                                        <h3 class="mb-4"><?php echo $pro_dtls->title;?></h3>
                                        <p align="justify"><?php echo $pro_dtls->des_1?></p>
                                        <blockquote class="blockquote iq-mtb-30 iq-pl-20">
                                            <p class="mb-0"><?php echo $pro_dtls->des_2?></p>
                                        </blockquote>
                                    </div>
                                </article>
                            </div>
...
<!-- Mirrored from lifesthtml.websitelayout.net/index-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Aug 2022 11:52:51 GMT -->
</html>