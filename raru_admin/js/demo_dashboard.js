$(function(){
    ...
    if($("#dashboard-bar-1").length) {
        Morris.Donut({
            ...
            data: [
                {label: "Les Abymes", value: 10},
                {label: "Baie-Mahaulte", value: 25},
                {label: "Le Goiser", value: 50},
                {label: "Pointe-a-Pitre", value: 70}
            ],
            colors: ['#33414E', '#1caf9a', '#FEA223', '#FFAADD'],
            resize: true
        });
    }
