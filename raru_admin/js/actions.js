$(document).ready(function(){        
    ...
    /* MESSAGE BOX */
    $(document).on("bindMessageBox", function () {
        $(".mb-control").on("click",function(){
            var box = $($(this).data("box")),
                deleteItem = $(this).data("item"),
                deleteItemNumber = $(this).data("itemNumber"),
                itemRid = $(this).data("itemRid") ? $(this).data("itemRid") : "";
            ...
            if(box.length > 0){
                ...
                if($(this).data("box") == "#delete-order-detail") {
                    $("input[name='deleteItem']").val(deleteItem);
                    $("input[name='deleteItemNumber']").val(deleteItemNumber);
                    $("input[name='itemRid']").val(itemRid);
                }

                box.find('button').on("click", function(e) {
                    e.stopPropagation();
                    var isDelete = $(this).data('value');
                    if(!!isDelete) {
                        if(itemRid && itemRid !== "") {
                            if(location.href.indexOf("?") !== -1) {
                                window.location = location.href +"&action=delete&"+ deleteItem +"="+ deleteItemNumber +"&rid="+ itemRid;
                                // alert(location.href +"&action=delete&"+ deleteItem +"="+ deleteItemNumber +"&rid="+ itemRid);
                            } else {
                                window.location = location.href +"?action=delete&"+ deleteItem +"="+ deleteItemNumber +"&rid="+ itemRid;
                                // alert(location.href +"?action=delete&"+ deleteItem +"="+ deleteItemNumber +"&rid="+ itemRid);
                            }
                            ...
                            if(location.href.indexOf("?") !== -1) {
                                window.location = location.href +"&action=delete&"+ deleteItem +"="+ deleteItemNumber;
                                // alert(location.href +"&action=delete&"+ deleteItem +"="+ deleteItemNumber);
                            } else {
                                window.location = location.href +"?action=delete&"+ deleteItem +"="+ deleteItemNumber;
                                // alert(location.href +"?action=delete&"+ deleteItem +"="+ deleteItemNumber);
                            }
