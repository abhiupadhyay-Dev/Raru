                                    ...
                                    <ul class="navbar-nav ms-auto" id="nav" style="display: none;">
                                        ...
                                        <li><a href="our-services.html">Our Services</a>
                                            <ul>
                                                ...
                                                <!-- <li><a href="fund-management-entity.html">Fund Management Entity</a></li>  -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="career-content"> 
                            <h2 style="magin-bottom:10px;">Currently not hiring.</h2>
                            <h3>Job Opening:</h3>                           
                            <p class="text-justify">we are always looking for human capital if you are capable, talented and willing to work with us. Mail your CV to <a href="mailto:info@rarucapital.com.">info@rarucapital.com.</a></p>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 ">
                        <div class="career-form">
                            <?php if(!empty($statusMsg)){ ?>
                                <p  style="color: red;font-size: 22px;" class="statusMsg <?php echo !empty($msgClass)?$msgClass:''; ?>"><?php echo $statusMsg; ?></p>
                            <?php } ?>
                            <form class="quform" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" type="text" name="name" placeholder="Your name here" value="<?php echo !empty($postData['name'])?$postData['name']:''; ?>" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" type="text" name="email" placeholder="Your email here" value="<?php echo !empty($postData['email'])?$postData['email']:''; ?>" required />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Text input element -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <input class="form-control" type="text" name="phone" placeholder="Your phone here" value="<?php echo !empty($postData['phone'])?$postData['phone']:''; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Text input element -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="subject">Post Applied for</label>
                                                <div class="quform-input">
                                                    <input class="form-control"  type="text" name="post_applied" placeholder="Post Applied for"  value="<?php echo !empty($postData['post_applied'])?$postData['post_applied']:''; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End Text input element -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="message">Upload Your CV </label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                ...
                                                <div class="quform-input">
                                                    <textarea class="form-control h-auto"  name="message" rows="4" placeholder="Tell us a few words"><?php echo !empty($postData['message'])?$postData['message']:''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Begin Submit button -->
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner mt-4">
                                                <button class="butn-style3 text-black" name="submit" type="submit"><span>Send Message</span></button>
                                            </div>
                                        </div>
                                        <!-- End Submit button -->
